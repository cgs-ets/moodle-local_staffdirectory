...
/**
 * Strings for CGS Staff Directory
 *
...
$string['title'] = 'Staff Directory';
$string['pluginname'] = 'Staff Directory';
$string['privacy:metadata'] = 'Staff Directory does not store any personal data.';
